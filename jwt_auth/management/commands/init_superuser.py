...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            user_info1 = UserInfo.objects.create(name='michael', invest_amount = '',invest_period = '', phone='080-1234-5678')
            m_user1 = User.objects.create(user_info=user_info1, email='rshci_ai@yahoo.com', password=make_password('password'), permission='admin', is_active=True, is_superuser=True, is_staff=True)
